...
if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($result)> 0) {
      ...
      $row =mysqli_fetch_assoc($result);
        ...
        if($_SESSION['choice'] == 'Customer'){
          header("Location: customer.php");
        }

        else if($_SESSION['choice'] == 'Admin'){
          header("Location: dashboard.php");
        }

        else if($_SESSION['choice'] == 'Supplier'){
    ...
    <div class="formcontainer">
        ...
        <form style="padding-top:200px ;width: 300px;" method="post" action="#">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                <select class="form-select" name="choice" aria-label="Default select example" style="border-radius: 100px; background-color: rgba(228, 236, 236, 0.607);height: 25px;font-size:10px">
