...
<div style="display: flex;gap: 15px;position: scroll;">
    ...
    <div style="height: 160vh;width: 14%;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;padding-top: 120px;">
        ...
        <a href="logout.php" style="list-style: none; color: black;text-decoration: none;position: fixed;margin-top: 30px;"><p style="font-family: Segoe UI;" class="sidebar"><img src="images/right-from-bracket-solid.svg" height="30px" width="30px" alt=""  style="padding: 8px;" >Logout</p></a>
              ...
              <form class="form-horizontal" style="padding: 20px;">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input type="email" class="form-control" id="name"  name="name" autocomplete="off" required="">
                  </div>
                  </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                      <input type="number" class="form-control" id="name"  name="name" autocomplete="off" required="">
                      </div>
                      </div>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                      <input type="password" class="form-control" id="name"  name="name" autocomplete="off" required="">
                      </div>
                      </div>
                      </div>


               <button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" style="background-color: red;">Update</button>
